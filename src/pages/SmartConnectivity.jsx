import { ArrowLeft, Wifi, CheckCircle, Smartphone, Globe, Bell } from 'lucide-react';

const SmartConnectivity = ({ onBack }) => {
  const features = [
    'Remote viewing from anywhere in the world',
    'Free mobile app for iOS and Android',
    'Real-time live streaming',
    'Multi-device viewing support',
  ...
  const specifications = [
    ...
    { label: 'Live Streams', value: 'Up to 16' },
  ...
  const benefits = [
    {
      ...
      title: 'Mobile App',
      description: 'Control everything from your smartphone with our free app'
    },
    {
      icon: <Globe className="w-8 h-8 text-accent" />,
      title: 'Remote Access',
      description: 'View live footage from anywhere in the world'
    },
    {
      icon: <Bell className="w-8 h-8 text-accent" />,
      title: 'Smart Alerts',
      description: 'Get instant notifications on your phone for any activity'
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="font-orbitron text-4xl md:text-5xl font-bold text-text-primary mb-4">
              Smart <span className="text-accent">Connectivity</span>
            </h1>
            <p className="text-text-secondary font-inter text-lg max-w-2xl mx-auto">
              Remote viewing via mobile app anywhere, anytime
            </p>
          </div>
        </div>
      </section>
...
export default SmartConnectivity;
